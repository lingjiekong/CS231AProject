...
sequence_name = 'washing-dishes_3425035805_neal';
subfolder_name = 'washing-dishes_static';
% depth_bin_folder = '../rgbdt_data/kitchen/peanut-butter_4017149350_emi/';

% get output from orb-slam
file_ID = fopen(['/cvgl/u/rsluo/rgbdt_robotics/sequences_visualization/' sequence_name '/egocentric_ORB/' subfolder_name '/CameraTrajectory.txt'], 'r');
...
file_ID_assoc = fopen(['/cvgl/u/rsluo/rgbdt_robotics/sequences_visualization/' sequence_name '/egocentric_ORB/' subfolder_name '/associations.txt'], 'r');
...
% file to write to
write_file = ['/cvgl/u/rsluo/rgbdt_robotics/sequences_visualization/' sequence_name '/egocentric_ORB/3d_maps/dense_static_map.txt']; 
...
%     bin_image = bin_image';
    ...
    rgb_image = imread(['/cvgl/u/rsluo/rgbdt_robotics/sequences_visualization/' sequence_name '/egocentric_ORB/' subfolder_name '/' rgb_filename]);
    depth_image = imread(['/cvgl/u/rsluo/rgbdt_robotics/sequences_visualization/' sequence_name '/egocentric_ORB/' subfolder_name '/' depth_filename]);
